        ...
        <RevealOnScroll>
            <div className="w-full max-w-5xl px-4 sm:px-6 lg:px-8 mx-auto">
                ...
                <form className="w-full space-y-6" onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="block w-full bg-blue-500 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]">Send Message</button>
                </form>
            </div>
        </RevealOnScroll>
    </section>
